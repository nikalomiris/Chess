...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!Board.isGameOver()) {
            System.out.print((turn ? "Whites turn " : "Blacks turn ") + "Enter your next move (fromX fromY toX toY, e.g. 0 0 1 2): ");
            for (int i = 0; i < 4; i++) {
                nextMove[i] = input.nextInt();
            }
            System.out.print("\n");
            System.out.println("Next move for " + (turn ? "Whites " : "Blacks ") + "is " + Board.getPiecePositions()[nextMove[0]][nextMove[1]].getName()
